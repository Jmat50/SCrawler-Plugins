...
Namespace EFUKTPlugin
    ...
    Public Class SiteSettings
        ...
        <PropertyOption(ControlText:="Domain", ControlToolTip:="EFUKT domain for URL checks"), PXML>
        ...
        Public Function IsMyUser(ByVal UserURL As String) As ExchangeOptions Implements ISiteSettings.IsMyUser
            ...
            If String.IsNullOrWhiteSpace(key) Then key = "efukt"
        ...
        Public Function IsMyImageVideo(ByVal URL As String) As ExchangeOptions Implements ISiteSettings.IsMyImageVideo
            ...
            Dim isMediaHost As Boolean = host.IndexOf("efukt.com", StringComparison.OrdinalIgnoreCase) >= 0 OrElse
                                         host.IndexOf("servev.efukt.com", StringComparison.OrdinalIgnoreCase) >= 0
        ...
        Private Shared Function IsVideoLikePath(ByVal absolutePath As String) As Boolean
            ...
            Return Regex.IsMatch(absolutePath, "^/[0-9]+_[^/]+\.html$", RegexOptions.IgnoreCase)
        End Function
