...
Namespace RedTubePlugin
    ...
    Public Class SiteSettings
        ...
        <PropertyOption(ControlText:="Domain", ControlToolTip:="RedTube domain for URL checks"), PXML>
        Public ReadOnly Property Domain As PropertyValue

        <PropertyOption(ControlText:="Listing URL Pattern", ControlToolTip:="Use {0} for a path or listing key"), PXML>
        ...
        Public Function IsMyUser(ByVal UserURL As String) As ExchangeOptions Implements ISiteSettings.IsMyUser
            ...
            If String.IsNullOrWhiteSpace(key) Then key = "redtube"
        ...
        Public Function IsMyImageVideo(ByVal URL As String) As ExchangeOptions Implements ISiteSettings.IsMyImageVideo
            ...
            If targetDomain <> String.Empty AndAlso HostMatchesDomain(host, targetDomain) Then
                Dim isVideoPage As Boolean = IsVideoLikePath(path) OrElse
            ...
            Dim isMediaHost As Boolean = host.IndexOf("rdtcdn.com", StringComparison.OrdinalIgnoreCase) >= 0 OrElse
                                         host.IndexOf("redtube.com", StringComparison.OrdinalIgnoreCase) >= 0
            If isMediaHost AndAlso path.IndexOf(".mp4", StringComparison.OrdinalIgnoreCase) >= 0 Then
                Return New ExchangeOptions With {
                    .SiteName = Site,
                    .HostKey = PluginKey,
                    .UserName = String.Empty,
        ...
        Private Shared Function IsVideoLikePath(ByVal absolutePath As String) As Boolean
            ...
            Return Regex.IsMatch(absolutePath, "^/[0-9]{5,}(?:/[^/?#]+)?/?$", RegexOptions.IgnoreCase)
        End Function
