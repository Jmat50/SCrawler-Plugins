...
Namespace DeviantArtPlugin
    ...
    Public Class SiteSettings
        ...
        <PropertyOption(ControlText:="Domain", ControlToolTip:="DeviantArt domain for URL checks"), PXML>
        Public ReadOnly Property Domain As PropertyValue

        <PropertyOption(ControlText:="Listing URL Pattern", ControlToolTip:="Use {0} for a username or path key"), PXML>
        ...
        Private Shared Function ExtractUserKey(ByVal uri As Uri) As String
            ...
            If host.EndsWith(".deviantart.com", StringComparison.OrdinalIgnoreCase) AndAlso
               host <> "www.deviantart.com" AndAlso
               host <> "deviantart.com" Then
            ...
            If parts.Length >= 2 AndAlso parts(1).Equals("art", StringComparison.OrdinalIgnoreCase) Then Return parts(0)
            Return parts(0)
        End Function
        ...
        Private Function IsDirectMediaUrl(ByVal uri As Uri) As Boolean
            ...
            Dim isDeviantArtHost As Boolean = host.Contains("deviantart.com") OrElse host.Contains("deviantart.net") OrElse host.Contains("wixmp.com") OrElse host.Contains("sta.sh")
            If Not isDeviantArtHost Then Return False
            ...
            If path.Contains("/download/") Then Return True
