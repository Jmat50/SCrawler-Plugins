...
Namespace MotherlessPlugin
    ...
    Public Class SiteSettings
        ...
        <PropertyOption(ControlText:="Domain", ControlToolTip:="Motherless domain for URL checks"), PXML>
        Public ReadOnly Property Domain As PropertyValue

        <PropertyOption(ControlText:="Listing URL Pattern", ControlToolTip:="Use {0} for a path or key"), PXML>
        ...
        Public Function IsMyUser(ByVal UserURL As String) As ExchangeOptions Implements ISiteSettings.IsMyUser
            ...
            If String.IsNullOrWhiteSpace(key) Then key = "motherless"
        ...
        Public Function IsMyImageVideo(ByVal URL As String) As ExchangeOptions Implements ISiteSettings.IsMyImageVideo
            ...
            Dim targetDomain As String = GetDomain()
            If targetDomain <> String.Empty AndAlso HostMatchesDomain(host, targetDomain) AndAlso IsVideoLikePath(path) Then
                Return New ExchangeOptions With {
                    .SiteName = Site,
                    .HostKey = PluginKey,
            ...
            If host.IndexOf("motherlessmedia.com", StringComparison.OrdinalIgnoreCase) >= 0 AndAlso
               (path.IndexOf(".mp4", StringComparison.OrdinalIgnoreCase) >= 0 OrElse
        ...
        Private Shared Function IsVideoLikePath(ByVal absolutePath As String) As Boolean
            ...
            Return Regex.IsMatch(absolutePath, "^/[A-F0-9]{6,8}$", RegexOptions.IgnoreCase)
        End Function
